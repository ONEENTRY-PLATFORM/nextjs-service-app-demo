...
/**
 * Loading skeleton for the category gallery route.
 *
 * Mirrors the real page shell (`app/gallery/[handle]/page.tsx` → gradient line
 * + `GalleryPageContent`): the gradient strip, a fixed-height filter bar block
 * and the photo grid with exactly the same grid/gap/padding classes and
 * `aspect-4/5` cells — so swapping the skeleton for the content does not shift
 * the layout.
 *
