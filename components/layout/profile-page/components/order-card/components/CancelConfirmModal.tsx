      ...
      >
        <div className="w-full max-w-sm rounded-2xl bg-white p-6 text-center shadow-modal">
          ...
          <div className="flex gap-2">
            ...
            >
              {dictText(dict, 'keep_appointment_text', 'Keep appointment')}
            </button>
            <button
              onClick={onConfirm}
              disabled={isPending}
            ...
            >
              {isPending
                ? dictText(dict, 'cancelling_text', 'Cancelling…')
                : dictText(dict, 'yes_cancel_text', 'Yes, cancel')}
            </button>
          </div>
        </div>
      </div>
