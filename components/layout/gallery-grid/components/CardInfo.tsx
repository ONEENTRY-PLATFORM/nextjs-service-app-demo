...
/**
 * CardInfo component to display information about a gallery item.
 *
 ...
 * at the bottom of a gallery card.
 ...
 * @param   {object}           [props.cardData.spec] - Specialization information with optional title
...
const CardInfo = ({
  ...
  /** Render gallery card information with master name, specialization and profile link */
  return (
