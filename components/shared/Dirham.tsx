 ...
 * @param   {CSSProperties} [props.style]     - Inline styles to apply to the SVG element
 * @param   {boolean}       [props.big]       - In large prices the symbol reads better 20% smaller and bottom-aligned
 * @returns {JSX.Element}                     Dirham symbol as an inline SVG element
 */
const Dirham = ({
  className = '',
  style,
  ...
  return (
    <svg
      ...
      height={big ? '0.66em' : '0.82em'}
      width={big ? '0.76em' : '0.94em'}
      role="img"
      aria-label="dirham"
      fill="currentColor"
      className={className}
      style={{
        ...
        verticalAlign: big ? 'baseline' : '-0.04em',
        marginRight: '0.14em',
        ...style,
      }}
    >
